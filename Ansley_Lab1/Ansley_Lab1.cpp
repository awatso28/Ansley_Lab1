...
// Ansley_Lab1.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
    std::cout << "Hello from student A! This is my first Git commit!.n";
